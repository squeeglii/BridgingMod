...
public class BridgingKeyMappings {
    ...
    public static final KeyMapping TOGGLE_BRIDGING = defineMapping(new KeyMapping("key.bridgingmod.toggle_bridging", InputConstants.Type.KEYBOARD, InputConstants.KEY_COMMA, CATEGORY));
